                    ...
                    <div id="timeline">
                        <div class="timeline" id="tmlin">
                            ...
                            <div class="date_separator" id="october">
                                <span>{!! strtoupper(Date('F Y',strtotime('-1 month') )) !!}</span>
                            </div>
                            <ul class="columns">
                                <li>
                                    <div class="timeline_element partition-white">
                                        <div class="timeline_date">
                                            <div>
                                                ...
                                                <div class="inline-block">
                                                    <span class="block week-day text-extra-large">Wensdey</span>
                                                    <span class="block month text-large text-light">3:00 PM</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="timeline_title">
                                            <i class="fa fa-bullhorn fa-2x pull-left fa-border"></i>
                                            <h4 class="light-text no-margin padding-5">Yearly Report</h4>
                                        </div>
                                        <div class="timeline_content">
                                            Annual report of overall records of finance, academic have to submit before end of this week. so, this is to notify all the teachers to co-operate class-teachers to complete their report of class.
                                        </div>
                                        <div class="readmore">
                                    ...
                                    <div class="timeline_element partition-white">
                                        <div class="timeline_date">
                                            <div>
                                                ...
                                                <div class="inline-block">
                                                    <span class="block week-day text-extra-large">Wensdey</span>
                                                    <span class="block month text-large text-light">2:00 PM</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="timeline_title">
                                            <i class="fa fa-bullhorn fa-2x pull-left fa-border"></i>
                                            <h4 class="light-text no-margin padding-5">Staff Loan</h4>
                                        </div>
                                        <div class="timeline_content">
                                            Please have attention on the list provided to your department regarding documents to approve loan for our staff. so, kindly note all documents and submit it before the month end.
                                        </div>
                                        <div class="readmore">
                                            <a href="#" class="btn btn-primary btn-o btn-wide">
                                                Read More <i class="fa fa-arrow-circle-right"></i>
                                    ...
                                    <div class="timeline_element partition-gray">
                                        <div class="timeline_date">
                                            <div>
                                                ...
                                                <div class="inline-block">
                                                    <span class="block week-day text-extra-large">Wensdey</span>
                                                    <span class="block month text-large text-light">1:30 PM</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="timeline_title">
                                            <i class="fa fa-trophy fa-2x pull-left fa-border"></i>
                                            <h4 class="text-white no-margin padding-5">Time to congrats Mr.Raghav</h4>
                                        </div>
                                        <div class="timeline_content ">
                                            <div class="row">
                                                <div class="col-md-3 col-xs-4"><img src="assets/images/photodune-4043508-3d-modern-office-room-l.jpg" alt="offce" class="img-responsive"/>
                                                ...
                                                <div class="col-md-9 col-xs-8">
                                                    Its time to Congrats to Mr. Raghav, Head of Deccan branch for selection as chief of organization committee. we are organizing small event on this occassion so, this is request to all teachers to have part of this event.
                                                </div>
                                            </div>
                                        </div>
                                        <div class="readmore">
