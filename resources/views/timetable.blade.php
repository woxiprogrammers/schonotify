                    ...
                    if ( arr[3].length > j ) {
                        if ( arr[3][j]["is_break"] == 0 ) {
                            if(arr[3][j]['teacher_is_active'] == 1) {
                                tds += '<td><div class="outer-div-tm"><a data-target="#myModal1" data-toggle="modal" class="show-tab pull-right timetable-sect" onclick="editPeriod('+arr[3][j]['id']+')"><i class="fa fa-pencil edit-user-info"></i></a><h4 class="center">'+ arr[3][j]["subject"] +'</h4><h5 class="center"><small>'+ arr[3][j]["teacher"] + " "+arr[2][j]["teacher_last_name"] +'</small></h5><div class="center"><span class="label label-sm label-info">'+arr[3][j]["start_time"]+ '-' +arr[3][j]["end_time"]+'</span></div></td>';
                            } else {
                    ...
                    if ( arr[4].length > j ) {
                        if( arr[4][j]["is_break"] == 0 ) {
                            if(arr[4][j]['teacher_is_active'] == 1) {
                                tds += '<td><div class="outer-div-tm"><a data-target="#myModal1" data-toggle="modal" class="show-tab pull-right timetable-sect" onclick="editPeriod('+arr[4][j]['id']+')"><i class="fa fa-pencil edit-user-info"></i></a><h4 class="center">'+ arr[4][j]["subject"] +'</h4><h5 class="center"><small>'+ arr[4][j]["teacher"]+ " "+arr[2][j]["teacher_last_name"] +'</small></h5><div class="center"><span class="label label-sm label-info">'+arr[4][j]["start_time"]+ '-' +arr[4][j]["end_time"]+'</span></div></td>';
                            } else {
                    ...
                    if ( arr[5].length > j ) {
                        if( arr[5][j]["is_break"] == 0 ) {
                            if(arr[5][j]['teacher_is_active'] == 1) {
                                tds += '<td><div class="outer-div-tm"><a data-target="#myModal1" data-toggle="modal" class="show-tab pull-right timetable-sect" onclick="editPeriod('+arr[5][j]['id']+')"><i class="fa fa-pencil edit-user-info"></i></a><h4 class="center">'+ arr[5][j]["subject"] +'</h4><h5 class="center"><small>'+ arr[5][j]["teacher"]+ " "+arr[2][j]["teacher_last_name"] +'</small></h5><div class="center"><span class="label label-sm label-info">'+arr[5][j]["start_time"]+ '-' +arr[5][j]["end_time"]+'</span></div></td>';
                            } else {
                    ...
                    if ( arr[6].length > j ) {
                        if ( arr[6][j]["is_break"] == 0 ) {
                            ...
                            if(arr[6][j]['teacher_is_active'] == 1) {
                                tds += '<td><div class="outer-div-tm"><a data-target="#myModal1" data-toggle="modal" class="show-tab pull-right timetable-sect" onclick="editPeriod('+arr[6][j]['id']+')"><i class="fa fa-pencil edit-user-info"></i></a><h4 class="center">'+ arr[6][j]["subject"] +'</h4><h5 class="center"><small>'+ arr[6][j]["teacher"] + " "+arr[2][j]["teacher_last_name"] +'</small></h5><div class="center"><span class="label label-sm label-info">'+arr[6][j]["start_time"]+ '-' +arr[6][j]["end_time"]+'</span></div></td>';
                            } else {
