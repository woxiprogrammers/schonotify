                                        ...
                                        <div class="panel-body">
                                            ...
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a data-toggle="modal" data-target="#myChildrensEdit" onclick="getMyChildren({!! $student->id !!})">Edit <i class="fa fa-pencil edit-user-info"></i></a></td>
                                                </tr>
                                                @endforeach
                                            </table>
                                            </div>
...
function getMyChildren(id)
{
@foreach($students as $student)
    if({!! $student->id !!}==id)
    {
        console.log({!! $student !!});
        var str='<form id="formEditAccount" method="post" action="/edit-student/{!! $student->id !!}"  enctype="multipart/form-data">'+
                '<input name="_method" type="hidden" value="PUT">'+
                    '<fieldset>'+
                        '<div class="row">'+
                            '<div class="col-md-6">'+
