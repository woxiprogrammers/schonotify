        ...
        <div class="app-content">
            ...
            <div class="main-content" >
                <div class="wrap-content container" id="container">
                    ...
                    <section id="page-title" class="padding-top-15 padding-bottom-15">
                        <div class="row">
                            <div class="col-sm-7">
                                ...
                                <span class="mainDescription">SY Waiting / Merit List Form</span>
                                <br>
                                <h5 style="color:red">If you are already registered ,then <a href="/syEnquiry/check-enquiry">Click Here</a></h5>
                            </div>
                        </div>
                    </section>
                    <!-- end: DASHBOARD TITLE -->
                    ...
                    <div class="col-md-12">
                        <form method="post" action="/syEnquiry/store-sy-student-enquiry-without-login" role="form" id="studentEnquiry" onsubmit="parent.scrollTo(0, 0); return true" enctype="multipart/form-data">
                            <fieldset>
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="class_applied" name="class_applied" style="-webkit-appearance: menulist;">
                                                ...
                                                <option value='SYBBA'>FY BBA</option>
                                                <option value='MCOM'>M COM(Part 1)</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group"> <!-- Date input -->
                                            <label class="control-label">Examination Board /University <span class="symbol required"></span></label>
