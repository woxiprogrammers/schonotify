        ...
        <!-- end: TOP NAVBAR -->
            <div class="main-content" >
                <div class="wrap-content container" id="container">
                    ...
                    <div class="col-md-12">
                        <form method="post" action="/syEnquiry/store-sy-student-enquiry" role="form" id="studentEnquiry" onsubmit="parent.scrollTo(0, 0); return true" enctype="multipart/form-data">
                            <fieldset>
                                <div class="row">
                                    <div class="col-md-6">
