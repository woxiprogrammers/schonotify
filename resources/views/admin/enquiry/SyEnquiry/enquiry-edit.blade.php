                    ...
                    <div class="main-content" >
                        <div class="wrap-content container" id="container">
                            ...
                            <div class="col-md-12">
                                ...
                                <form method="post" action="/syEnquiry/edit-enquiry/{{$enquiryInfo['id']}}" role="form" id="studentEnquiry" onsubmit="parent.scrollTo(0, 0); return true">
                                    ...
                                    <?php
                                    $enquiryFormFolderPath = url().env('SY_ENQUIRY_FORM_UPLOAD');
                                    ...
                                    <div class="row" style="background-color: #fefefe; padding: 20px;">
                                        <div class="col-md-12">
                                            <div class="w3-row-padding">
                                                ...
                                                <div class="w3-container w3-third">
                                                    <lable id="marksheet" style="font-size :14px; font-weight:bolder;"> {!!$enquiryInfo['class_applied']." Marksheet"!!}</lable>
