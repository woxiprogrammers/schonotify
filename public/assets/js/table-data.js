var TableData = function() {
    ...
    var runDataTable_class = function() {
        var newRow = false;
        var actualEditingRow = null;
        ...
        $('#sample_class').on('click', '.cancel-row', function(e) {
        ...
        $('#sample_class').on('click', '.delete-row', function(e) {
            e.preventDefault();
            if (newRow && actualEditingRow) {
                oTable.fnDeleteRow(actualEditingRow);
                newRow = false;
        ...
        $('#sample_class').on('click', '.save-row', function(e) {
            e.preventDefault();
        ...
        $('#sample_class').on('click', '.edit-row', function(e) {
            e.preventDefault();
            if (actualEditingRow) {
                if (newRow) {
                    oTable.fnDeleteRow(actualEditingRow);
        ...
        var oTable = $('#sample_class').dataTable({
            "aoColumnDefs" : [{
                "aTargets" : [0]
            }],
            "oLanguage" : {
