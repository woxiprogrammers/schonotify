var FormValidator = function () {
                ...
                if($('#dropdown').val() !== "")
                {
                    if($('#periods').val() !== "")
                    {
                        ...
                        for(var i=0; i<period; i++)
                        {
                            str+='<tr>' +
                                    '<td class="col-sm-2">' +
                                        '<div class="form-group"><input type="text" class="form-control center" id="Period_'+(i+1)+'" value="Period '+(i+1)+'" disabled>' +
                                        '</div>' +
                                    '</td>'+
                                    '<td class="col-sm-2">' +
    ...
    var runValidatorCreateTimetable = function () {
        var form2 = $('#createTimetableForm');
        var errorHandler2 = $('.errorHandler', form2);
        var successHandler2 = $('.successHandler', form2);
        $.validator.addMethod("getEditorValue", function () {
            $("#editor1").val($('#form2 .summernote').code());
